...
\section*{Приложение А2. Исходный код providers.dart}
\inputminted{dart}{code/lib/providers.dart}

\newpage

\section*{Приложение А3. Исходный код screens/authors\_page.dart}
\inputminted{dart}{code/lib/screens/authors_page.dart}

\newpage

\section*{Приложение А4. Исходный код screens/books\_page.dart}
\inputminted{dart}{code/lib/screens/books_page.dart}

\newpage

\section*{Приложение А5. Исходный код screens/home\_page.dart}
\inputminted{dart}{code/lib/screens/home_page.dart}

\newpage

\section*{Приложение А6. Исходный код widgets/author\_adding\_window.dart}
\inputminted{dart}{code/lib/widgets/author_adding_window.dart}

\newpage

\section*{Приложение А7. Исходный код widgets/book\_adding\_window.dart}
\inputminted{dart}{code/lib/widgets/book_adding_window.dart}

\newpage

\section*{Приложение А8. Исходный код widgets/book\_redacting\_popup.dart}
\inputminted{dart}{code/lib/widgets/book_redacting_popup.dart}

\newpage

\section*{Приложение А9. Исходный код utils/confirm\_delete\_popup.dart}
\inputminted{dart}{code/lib/utils/confirm_delete_popup.dart}

\newpage

\section*{Приложение А10. Исходный код validators/author\_validator.dart}
\inputminted[]{dart}{code/lib/validators/author_validator.dart}

\newpage

\section*{Приложение А11. Исходный код validators/book\_validator.dart}
