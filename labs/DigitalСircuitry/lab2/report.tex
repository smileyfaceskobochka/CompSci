...
На рисунке 1 представлена функциональная схема 2-разрядного параллельного регистра. Вход $D_i$ является информационным, выход $Q_i$ — выходом регистра. Все триггеры тактируются общим сигналом $C$.
