...
FormulaETeam::FormulaETeam(const std::string& name, const std::string& principal,
                           const std::string& hq,   const std::string& partner)
    : FormulaTeam(name, principal, hq),
      sustainabilityScore(50), batteryCapacityKwh(38.0), energyPartner(partner) {}

FormulaETeam::FormulaETeam(const std::string& name, const std::string& principal,
                           const std::string& hq,   const std::string& partner,
                           int sustainScore,        double batteryKwh,
...
std::string FormulaETeam::getSeriesName() const {
    return "Formula E";
}
