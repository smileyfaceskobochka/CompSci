...
public:
  ...
  int create_hub(int user_id, const std::string &name, const std::string &location, const std::string &serial_number);
  ...
  int update_user(int user_id, const std::string &username, const std::string &email, bool is_admin);
  void delete_user(int user_id);
  std::vector<std::tuple<int, int, std::string, std::string, std::string, std::string>> get_all_hubs();
  std::vector<std::tuple<int, int, std::string, std::string, std::string, std::string>> get_hubs_filtered(const std::string &filter_text);
  int update_hub(int hub_id, int user_id, const std::string &name, const std::string &location, const std::string &serial_number);
  void delete_hub(int hub_id);
  std::vector<std::tuple<int, int, std::string, std::string, std::string, std::string>> get_all_devices();
  std::vector<std::tuple<int, int, std::string, std::string, std::string, std::string>> get_devices_filtered(const std::string &filter_text);
  int update_device(int device_id, int hub_id, int type_id, const std::string &name, const std::string &status);
